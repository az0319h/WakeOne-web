...
- **타임스탬프**: 절대 시각 `yyyy-MM-dd (EEE) HH:mm:ss` — 상대 시각(`N시간 전` 등) **금지** (`core-conventions.mdc` §날짜·시각 표시)
...
참조: `activity-logs-table/columns.tsx` · `system-email-logs-table/columns.tsx`
