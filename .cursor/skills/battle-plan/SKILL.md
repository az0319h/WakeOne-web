---
name: battle-plan
description: Before ANY significant development task (new feature, refactor, integration, migration), run a complete planning ritual - clarify scope, assess risks, estimate time, get confirmation. Do not start coding until the battle plan is approved. Use when the user is about to start non-trivial work.
---
...
A basic plan mode is just "read-only mode + write a markdown file." It doesn't
assess risks, estimate time, define done, or check scope. This skill orchestrates
a complete planning ritual using composable skills before any significant work
begins.
...
Use search and file reading to actually explore. Don't guess.
