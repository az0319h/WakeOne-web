...
interface NotifUserComboboxProps {
  value: string;
...
function NotifUserComboboxUserList({
  ...
  value,
  onSelect
}: NotifUserComboboxUserListProps) {
...
export function NotifUserCombobox({ value, onValueChange }: NotifUserComboboxProps) {
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          data-testid='notif-user-combobox'
        >
